import { Car, BookOpen, Mail, Phone, MapPin, Globe, ArrowUpRight } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-slate-900">
          ...
          <div className="flex flex-col gap-3 text-left">
            <h4 className="font-bold uppercase tracking-wider text-slate-200 text-[11px]">Marketplace</h4>
            ...
            <a href="#search" className="hover:text-white transition-colors">Search Vehicles</a>
            <a href="#why-us" className="hover:text-white transition-colors">Capabilities</a>
          ...
          <div className="flex flex-col gap-3 text-left">
            ...
            <a href="#docs" className="hover:text-white transition-colors">API Specs</a>
          ...
          <div className="flex flex-col gap-3 text-left">
            ...
            <div className="flex items-center gap-2 text-slate-400">
              ...
              <span>support@autovance.io</span>
            </div>
            <div className="flex items-center gap-2 text-slate-400">
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-slate-500 text-[11px]">
          ...
          <div className="flex items-center gap-6">
            <Link to="/home" className="hover:text-slate-300 transition-colors">Marketplace Home</Link>
            <Link to="/profile" className="hover:text-slate-300 transition-colors">Profile Settings</Link>
            {isAdmin && <Link to="/dashboard" className="hover:text-slate-300 transition-colors">Admin Dashboard</Link>}
          </div>
        </div>
      </div>
    </footer>
