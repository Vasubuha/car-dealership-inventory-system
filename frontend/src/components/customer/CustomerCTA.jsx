          ...
          <div className="relative z-10 max-w-3xl mx-auto flex flex-col items-center gap-6">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
              <button
                ...
                className="inline-flex items-center gap-2.5 px-8 py-4 rounded-xl text-sm font-extrabold text-blue-900 bg-white hover:bg-slate-100 shadow-xl shadow-blue-950/20 active:scale-[0.98] transition-all"
              >
              ...
              >
                <span>Manage Profile & Saved Stock</span>
              </button>
            </div>
          </div>
        </div>
