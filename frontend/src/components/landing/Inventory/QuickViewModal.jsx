...
export default function QuickViewModal({ vehicle, onClose, isWishlisted, onToggleWishlist }) {
  ...
  return (
    <>
              ...
              <div className="lg:col-span-5 flex flex-col justify-between h-full gap-6">
                ...
                {reserved && (
                  <div className="p-3 rounded-xl bg-emerald-50 text-emerald-800 border border-emerald-200 text-xs font-bold flex items-center gap-2">
                    ...
                    <span>Reservation Initiated! Redirecting to Purchases...</span>
                  </div>
                )}
                ...
                <div className="flex flex-col gap-2.5 pt-4 border-t border-slate-100">
                  <button
                    ...
                    className="w-full inline-flex items-center justify-center gap-2 py-3 rounded-xl text-xs font-bold text-white bg-blue-600 hover:bg-blue-700 shadow-md shadow-blue-500/20 transition-all"
                  >
                    <span>{isAuthenticated ? 'Reserve Vehicle' : 'Login to Purchase'}</span>
      ...
      {/* Auth Modal Trigger for Guest Purchase Action */}
      <AuthModal
